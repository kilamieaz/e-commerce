                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
                    <div class="ps-checkout__billing">
                        ...
                        <div class="form-group form-group--inline">
                            ...
                            <input class="form-control" type="text" value="{{$user->userProfile->first_name}}" disabled>
                        </div>
                        <div class="form-group form-group--inline">
                            <label>Last Name<span>*</span>
                            </label>
                            <input class="form-control" type="text" value="{{$user->userProfile->last_name}}" disabled>
                        </div>
                        <div class="form-group form-group--inline">
                        ...
                        <div class="form-group form-group--inline">
                            ...
                            <input class="form-control" type="text" value="{{$user->userProfile->phone_number}}"
                                disabled>
                        </div>
                        <div class="form-group form-group--inline">
